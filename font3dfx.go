// Code generated by internal/genfont; DO NOT EDIT.

package vgarender

// font3dfx is a VGA text-mode font: 256 glyphs of 16 scanlines each.
// Each byte is one scanline; the most significant bit is the leftmost pixel.
var font3dfx = [256][16]byte{
